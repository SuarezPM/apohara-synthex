...
test("guard: bloquea bypasses por FQDN y direcciones IPv4-compatibles en IPv6", () => {
  for (const bad of [
    "http://localhost.", "http://127.0.0.1.", "http://metadata.google.internal.",
    "http://localhost%2e", "http://127.0.0.1%2e",
