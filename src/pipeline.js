...
export async function runPipeline(target, opts = {}) {
  ...
  // ⚡ Bolt: O(1) Map lookup replaces O(N^2) array.find() cross-reference bottleneck for large payloads
  // Manual iteration preserves original Array.prototype.find() first-match semantics.
