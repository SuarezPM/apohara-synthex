...
export const tools = [
  ...
  },
  {
    ...
    description:
      "Pipeline completo: scrapea el target vía Bright Data, deduplica y pre-filtra, clasifica bajo la lente pedida (GTM/Finance/Security) y devuelve un Evidence Report sellado.",
    parameters: z.object({
      target: z.string().describe("URL o término objetivo"),
      lens: z.enum(["gtm", "finance", "security"]).default("security"),
    }),
