...
📄 **[See a real Evidence Report → sample PDF](samples/synthex-evidence-report.pdf)** — 6 pages, sealed with Ed25519 + RFC 3161 (DigiCert) over an internal HMAC integrity checksum, generated by the real pipeline ([regenerate](scripts/gen-sample-report.mjs)).
