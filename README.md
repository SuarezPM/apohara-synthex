...
![Tests](https://img.shields.io/badge/tests-143%20%C2%B7%20133%20pass%20%C2%B7%2010%20skip-brightgreen)
...
```bash
npm test                                   # → 143 tests · 133 pass · 10 skip (opt-in live) · 0 fail
